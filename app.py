...
os.system(f"sudo apt search nvidia-driver")
...
os.system(f"git clone https://github.com/vladmandic/sd-extension-system-info /home/xlab-app-center/stable-diffusion-webui/extensions/sd-extension-system-info")
